        ...
        <div className="fixed w-full h-full top-0 left-0 flex items-center justify-center overflow-auto" style={{zIndex: 99}}>
            ...
            <div className="bg-soft w-9/12 md:w-2/5 mx-auto my-auto p-5 rounded-xl shadow-2xl z-50">
                ...
                <div className='flex flex-col justify-center items-center text-center'>
                    ...
                    <button className='text-base px-8 py-1.5 bg-red-800 rounded-2xl text-white hover:bg-red-600 mx-1.5 md:mx-2.5 font-medium transition duration-200 ease-in-out transform hover:scale-105' onClick={onClose}>OK</button>
                </div>
                {/* End Body */}
            </div>
            {/* End Modal Content */}
