...
const DropdownActionDocument = ({onDetail, onDelete}) => {
    ...
    return (
        <div className="relative inline-flex justify-center item-center flex-row-reverse">
            ...
            <div className={`mr-1 md:m-0 md:absolute right-7 -bottom-13 bg-white rounded-md shadow-lg overflow-hidden p-1 border-1 border-gray-200`}>
                <div ref={dropdown} onFocus={() => setDropdownOpen(true)} onBlur={() => setDropdownOpen(false)} >
                    <div className="flex flex-col w-36 min-w-max">
                        <button onClick={onDetail} className="px-4 py-2 text-sm text-gray-700 hover:bg-red-800 hover:text-white inline-flex items-center rounded-md">
            ...
            {confirmDelete && <ModalConfirm message='Delete this document?' onOK={handleDelete} onCancel={() => showConfirmDelete(false)} />}
        </div>
    )
}
