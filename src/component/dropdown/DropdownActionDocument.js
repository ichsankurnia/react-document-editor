...
const DropdownActionDocument = ({onEdit, onDelete}) => {
            ...
            <div className={`mr-1 md:m-0 md:absolute right-7 -bottom-13 bg-white rounded-md shadow-lg overflow-hidden p-1 border-1 border-gray-200`}>
                <div ref={dropdown} onFocus={() => setDropdownOpen(true)} onBlur={() => setDropdownOpen(false)} >
                    <div className="flex flex-col w-32">
                        <button onClick={handleEdit} className="px-4 py-2 text-sm text-gray-700 hover:bg-agroo5 hover:text-white inline-flex rounded-md">
                            <i className='ri-eye-fill mr-3 mt-0.5' />
                            <p>View Detail</p>
                        </button>
                        <button onClick={() => showConfirmDelete(true)} className="mt-1 px-4 py-2 text-sm text-gray-700 hover:bg-agroo5 hover:text-white inline-flex rounded-md">
...
export default DropdownActionDocument